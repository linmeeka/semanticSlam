...
public:
    ...
    cv::Mat GrabImageRGBD(const cv::Mat &imRGB, const cv::Mat &imD, const cv::Mat &mask, const cv::Mat &maskColor, const double &timestamp, cv::Mat &imRGBOut, cv::Mat &imDOut, cv::Mat &maskOut);
